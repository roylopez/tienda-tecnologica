...
public class GarantiaExtendida {
	...
	public String toString() {
		return "GarantiaExtendida [producto=" + producto + ", fechaSolicitudGarantia=" + fechaSolicitudGarantia
				+ ", fechaFinGarantia=" + fechaFinGarantia + ", precioGarantia=" + precioGarantia + ", nombreCliente="
				+ nombreCliente + "]";
	}
